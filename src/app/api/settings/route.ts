      ...
      settings = await withSchemaHeal(() =>
        db.schoolSettings.update({
          ...
          data: {
            ...
            barangMasukDocFormat: body.barangMasukDocFormat,
            barangMasukDocPrefix: body.barangMasukDocPrefix,
            orderDocFormat: body.orderDocFormat,
            orderDocPrefix: body.orderDocPrefix,
            kopLines,
      ...
      settings = await withSchemaHeal(() =>
        db.schoolSettings.create({
          data: {
            ...
            barangMasukDocFormat: body.barangMasukDocFormat ?? "{NOMOR}/{PREFIX}/{KODE_SEKOLAH}-{KODE_UNIT}/{ROMAN}/{TAHUN}",
            barangMasukDocPrefix: body.barangMasukDocPrefix ?? "BM",
            orderDocFormat: body.orderDocFormat ?? "{NOMOR}/{PREFIX}/{KODE_SEKOLAH}-{KODE_UNIT}/{ROMAN}/{TAHUN}",
            orderDocPrefix: body.orderDocPrefix ?? "PB",
            kopLines,
            principalName: body.principalName ?? "",
            principalNip: body.principalNip ?? "",
            treasurerName: body.treasurerName ?? "",
